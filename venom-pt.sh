...
echo  "Bot by: Venom 100% pt-en-indo" | lolcat -a -d 50 
...
figlet -c -f slant -t 'Venom bot-tec' | lolcat 
echo "[*] Protinho todas as dependências forem feitas digite o comando | node venombot-pt | para iniciar o bot"
echo "Esta script foi feita por 559791435184 / 6285875158363 :venom,,,,mods duvidas chama la"
node venombot-pt